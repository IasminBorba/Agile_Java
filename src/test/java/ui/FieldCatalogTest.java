...
public class FieldCatalogTest extends TestCase {
    public void testAllFields() {
        ...
        assertEquals(NUMBER_SHORT_NAME, field.getShortName());
        ...
        assertEquals(DEPARTMENT_SHORT_NAME, field.getShortName());
        ...
        assertEquals(EFFECTIVE_DATE_SHORT_NAME, field.getShortName());
